...
class billClass:
    def __init__(self,root):
        ...
        #------------ footer -----------------
        lbl_footer=Label(self.root,text="IMS-Inventory Management System | Developed by Vivek\nFor any Technical Issues Contact: 7796264769",font=("times new roman",10),bg="#4d636d",fg="white").pack(side=BOTTOM,fill=X)
...
#---------------------- all functions ------------------------------
    ...
    def bill_top(self):
        ...
        bill_top_temp=f'''
\t\tABC-Inventory
\t Phone No. 1234567890 ,Chopada-415107
{str("="*46)}
